 ...
 *
 * Three sub-views:
 *   • About — explanation of what the Standards is and how to use it
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-6 py-3">
          ...
          <div className="flex gap-2 mt-2">
            {([
              ...
              { key: 'ask', label: '💬 Ask', desc: 'Chat with the Standards' },
            ] as const).map((p) => (
              <button
                key={p.key}
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-6 md:py-8 space-y-4 tab-content-enter">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 border border-gray-200">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            ...
            The Standards tells you, the manager, <strong>how to handle them</strong> —
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  the Standards content. Use it before, during, or after a tough conversation.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5">
          ...
          <p className="text-sm text-amber-900 leading-relaxed">
            The Standards grows over time. Right now it covers what we&apos;ve already documented — common
            policies and a few core scenarios. Keep adding content as you encounter situations the
            current Standards doesn&apos;t handle, so the next manager doesn&apos;t have to figure it out from scratch.
          </p>
